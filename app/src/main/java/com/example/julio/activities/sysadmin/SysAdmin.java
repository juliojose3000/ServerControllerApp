...
public class SysAdmin extends AppCompatActivity {
    ...
    public void seeFilesSA(View v){

        Intent i = new Intent(SysAdmin.this, ListServerFiles.class);
    ...
    public void seeProcessSA(View v){

        Intent i = new Intent(SysAdmin.this, ListServerProcess.class);
